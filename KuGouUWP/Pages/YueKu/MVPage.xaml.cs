    ...
    public sealed partial class MVPage : Page
    {
        ...
        private async Task LoadMVLibType()
        {
            try
            {
                ...
                var json = await httpclient.GetStringAsync("http://mobilecdn.kugou.com/api/v3/mv/taglistv2?plat=0");
        ...
        public class NewMVData
        {
            ...
            public async Task LoadData()
            {
                try
                {
                    page = page + 1;
                    var httpclient = new System.Net.Http.HttpClient();
                    var json = await httpclient.GetStringAsync("http://mobilecdn.kugou.com/api/v3/mv/list?type=" + (int)type + "&pagesize=20&page=" + page);
        ...
        public class MVLibData
        {
            ...
            public async Task LoadData()
            {
                try
                {
                    page = page + 1;
                    var httpclient = new System.Net.Http.HttpClient();
                    var json = await httpclient.GetStringAsync("http://mobilecdn.kugou.com/api/v3/mv/tagMvsV2?pagesize=20&year=" + year + "&plat=0&type=" + (int)type + "&page=" + page + "&ids=" + ids);
        ...
        private void FindBtnClicked(object sender, RoutedEventArgs e)
        {
