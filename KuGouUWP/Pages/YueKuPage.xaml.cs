    ...
    public sealed partial class YueKuPage : Page
    {
        ...
        public async Task LoadBannerData()
        {
            try
            {
                ...
                var json = await httpclient.GetStringAsync("http://ads.service.kugou.com/v1/mobile_fmbanner?userid=366079534&appid=1100&type=4&networktype=1&operator=7&version=8150&plat=0&ismonthly=0&clienttime=" + time + "&clientver=8150&mid=&key=" + key + "&isvip=0");
        ...
        public async void LoadTuiJianData()
        {
            ...
            try
            {
                ...
                var httpclient = new System.Net.Http.HttpClient();
                var bytes = await httpclient.GetByteArrayAsync(new Uri("http://service.mobile.kugou.com/v1/yueku/recommend?type=7&operator=7&plat=0&version=8150"));
        ...
        private void PaiHangList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if(list.SelectedIndex!=-1)
            {
                ...
                Frame.Navigate(typeof(Pages.YueKu.SongBanner), Class.data.ToJsonData(data));
        ...
        private void TopicList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            if (list.SelectedItem != null)
            {
                ...
                Frame.Navigate(typeof(Pages.WebPage), data.url);
                list.SelectedIndex = -1;
            }
        }
        ...
        private void SearchBtn_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            Frame.Navigate(typeof(Pages.Search),null,asd.DefaultNavigationTransitionInfo);
        }
        ...
        private void vlist_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            Frame.Navigate(typeof(Pages.MVListPage), data.vid);
        }
        ...
        private void SingerList_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                case 1:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "1", "1","华语男歌手" });
                    break;
                case 2:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "1", "2", "华语女歌手" });
                    break;
                case 3:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "1", "3", "华语组合" });
                    break;
                case 4:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "6", "1", "韩国男歌手" });
                    break;
                case 5:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "6", "2", "韩国女歌手" });
                    break;
                case 6:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "6", "3", "韩国组合" });
                    break;
                case 7:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "5", "1", "日本男歌手" });
                    break;
                case 8:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "5", "2", "日本女歌手" });
                    break;
                case 9:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "5", "3", "日本组合" });
                    break;
                case 10:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "2", "1", "欧美男歌手" });
                    break;
                case 11:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "2", "2", "欧美女歌手" });
                    break;
                case 12:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "2", "3", "欧美组合" });
                    break;
                case 13:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "4", "0", "其他歌手" });
                    break;
                case 14:
                    Frame.Navigate(typeof(Pages.YueKu.SingerListPage), new string[] { "0", "0", "酷狗音乐人" });
                    break;
                default:
                    break;
            }
        ...
        public class GeDanList
        {
            ...
            public async Task LoadData()
            {
                try
                {
                    page = page + 1;
                    var httpclient = new System.Net.Http.HttpClient();
                    var json = await httpclient.GetStringAsync("http://mobilecdn.kugou.com/api/v3/category/special?pagesize=20&withsong=0&plat=0&categoryid=" + categoryid + "&sort=" + ((int)sort).ToString() + "&page=" + page.ToString());
                    json = json.Replace("{size}", "150");
                    var obj = Windows.Data.Json.JsonObject.Parse(json);
        ...
        {
            Frame.Navigate(typeof(Pages.YueKu.MVPage));
        }
